...
const translations: Record<SupportedLanguage, Translations> = {
  es: {
    ...
    onboarding: {
      symptomsTitle: 'Analizador de Síntomas',
      symptomsText: 'Registra tus síntomas con texto o voz y obtén un análisis asistido por IA. Funciona también en modo offline.',
      appointmentsTitle: 'Citas Médicas',
      appointmentsText: 'Crea, reprograma y cancela citas. Si no hay conexión, tus acciones se encolan y se sincronizan al volver online.',
      alertsTitle: 'Alertas y Recomendaciones',
      alertsText: 'Recibe alertas importantes y recomendaciones personalizadas basadas en tu historial y análisis.',
      skip: 'Omitir',
      start: 'Empezar',
    },
    home: {
    ...
    profile: {
      ...
      age: 'Edad',
      baseDiagnosis: 'Diagnóstico base',
      riskFactors: 'Factores de riesgo',
      preferences: 'Preferencias',
      reminders: 'Recordatorios',
      notificationsFrequency: 'Frecuencia de notificaciones',
      low: 'Baja',
      normal: 'Normal',
      high: 'Alta',
      saveProfile: 'Guardar Perfil',
      saved: 'Perfil de salud actualizado',
    },
    wearables: {
  ...
  en: {
    ...
    onboarding: {
      symptomsTitle: 'Symptom Analyzer',
      symptomsText: 'Record your symptoms with text or voice and get an AI-assisted analysis. Works offline too.',
      appointmentsTitle: 'Medical Appointments',
      appointmentsText: 'Create, reschedule, and cancel appointments. If offline, actions are queued and synced when online.',
      alertsTitle: 'Alerts and Recommendations',
      alertsText: 'Receive important alerts and personalized recommendations based on your history and analysis.',
      skip: 'Skip',
      start: 'Start',
    },
    home: {
    ...
    profile: {
      ...
      age: 'Age',
      baseDiagnosis: 'Base diagnosis',
      riskFactors: 'Risk factors',
      preferences: 'Preferences',
      reminders: 'Reminders',
      notificationsFrequency: 'Notification frequency',
      low: 'Low',
      normal: 'Normal',
      high: 'High',
      saveProfile: 'Save Profile',
      saved: 'Health profile updated',
    },
    wearables: {
